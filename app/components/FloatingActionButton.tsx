...
export default function FloatingActionButton() {
  ...
  const actions = [
    { icon: Mail, label: "Contact Me", href: "/contact", color: "bg-blue-500 hover:bg-blue-600" },
    { icon: Briefcase, label: "Hire Me", href: "/contact?type=hire", color: "bg-green-500 hover:bg-green-600" },
    { icon: Heart, label: "Sponsor", href: "/contact?type=sponsor", color: "bg-purple-500 hover:bg-purple-600" },
    { icon: FileText, label: "Resume", href: "/resume.pdf", color: "bg-orange-500 hover:bg-orange-600" },
  ]
