          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="text-center lg:text-left animate-slide-up">
              <div className="mb-6">
                ...
                <div className="text-xl sm:text-2xl md:text-3xl text-gray-600 dark:text-gray-400 mb-6 h-12">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start mb-8">
                ...
                <Link
                  ...
                  className="inline-flex items-center px-4 py-2 text-sm bg-purple-100 dark:bg-purple-900 text-purple-700 dark:text-purple-300 rounded-lg hover:bg-purple-200 dark:hover:bg-purple-800 transition-colors"
                >
              ...
              <div className="grid grid-cols-3 gap-4 sm:gap-6 justify-center lg:justify-start max-w-md mx-auto lg:mx-0">
                <div className="text-center">
                  ...
                  <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Projects Built</div>
                </div>
                <div className="text-center">
                ...
                <div className="text-center">
                  ...
                  <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Companies Served</div>
                </div>
              </div>
            </div>
            ...
            <div className="relative mt-8 lg:mt-0">
              <div className="relative w-full max-w-lg mx-auto">
                ...
                <div className="relative bg-white dark:bg-gray-800 p-6 md:p-8 rounded-3xl shadow-2xl">
                  <div className="space-y-4">
                    ...
                    <div className="mt-6 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                      <div className="text-sm text-gray-600 dark:text-gray-400 mb-2">Latest Project</div>
                      <div className="font-semibold text-uiuc-blue">NeXTStep Platform</div>
                      <div className="text-sm text-gray-500 dark:text-gray-400">Full Stack LMS + Career Portal</div>
                    </div>
                  </div>
                </div>
              </div>
